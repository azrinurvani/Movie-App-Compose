...
import com.azri.moviedbjetpackcompose.R
import com.azri.moviedbjetpackcompose.movie.domain.models.Movie
import com.azri.moviedbjetpackcompose.ui.home.defaultPadding
...
fun TopContent(
    ...
    Box (
        ...
        MovieDetail(
            ...
            title = movie.title ?: "",
            genre = movie.genreIds ?: emptyList(),
            modifier = Modifier
